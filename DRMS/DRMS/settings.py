...
SECRET_KEY = 'django-insecure-^un2)mf#&2^q4zwj&xlrr%0+^tlb1n4^1v0(4cn^g=+1m0pif('
...
INSTALLED_APPS = [
    ...
    'corsheaders',  # CORS support for Flutter/Mobile apps
    'rest_framework',
...
REST_FRAMEWORK = {
    ...
    # Don't set default permission classes - let each viewset decide
